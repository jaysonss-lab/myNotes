...
Welcome to my personal repository of study notes, summaries, and quick references compiled from various courses, documentation, and YouTube tutorials.
...
This repository (`myNotes`) is a personal, open-source project created solely for educational and self-learning purposes. It contains my personal summaries, notes, and study materials compiled from various online courses, documentation, and YouTube tutorials.

### Intellectual Property & Attribution
* All rights, logos, and original content belong to their respective creators, instructors, and platforms. 
* I do not claim ownership over any of the third-party materials, concepts, or source videos referenced in these notes.
* Whenever possible, I have included links to the original content, creators, or courses. I highly encourage everyone to visit the original sources to support the creators.

### For Content Creators & Copyright Owners
If you are a copyright owner or a creator of any course/video referenced here and believe that the inclusion of any notes or screenshots violates your intellectual property rights, please do not hesitate to contact me. 

You can reach out by opening an **Issue** in this repository. Upon receiving your request, I will promptly modify or remove the relevant content.
